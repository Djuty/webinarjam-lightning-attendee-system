-- WebinarJam Database Setup for Supabase
...
CREATE INDEX IF NOT EXISTS idx_webinar_registrants_event_date 
...
CREATE INDEX IF NOT EXISTS idx_attendance_checks_ghl_contact 
...
-- Test the attendance summary view
-- SELECT * FROM webinar_attendance_summary LIMIT 5;

-- Test finding a registrant
...
-- Test recent checks
-- SELECT * FROM recent_attendance_checks LIMIT 10;
